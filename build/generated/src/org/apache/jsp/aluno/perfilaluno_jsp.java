...
public final class perfilaluno_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script>\n");
      out.write("\tvar valores = [10,40,60,100,50,60];\n");
  ...
  private boolean _jspx_meth_c_when_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                <div class=\"card text-white bg-primary mb-4 col-md-3\">\n");
        out.write("                    <div class=\"card-header\">Grafico 1</div>\n");
        out.write("                    <div class=\"card-body\">\n");
        out.write("                        <h5 class=\"card-title\">Título de Card Primary</h5>\n");
        out.write("<canvas id=\"myChart\" width=\"400\" height=\"400\"></canvas>\n");
        out.write("                    </div>\n");
        out.write("                </div>\n");
        out.write("\n");
        out.write("                <div class=\"card text-white bg-primary mb-4 col-md-3\">\n");
        out.write("                    <div class=\"card-header\">Grafico 2</div>\n");
        out.write("                    <div class=\"card-body\">\n");
        out.write("                        <h5 class=\"card-title\">Título de Card Primary</h5>\n");
        out.write("                        <p class=\"card-text\">Um exemplo de texto rápido para construir o título do card e fazer preencher o conteúdo do card.</p>\n");
        out.write("                    </div>\n");
        out.write("                </div>\n");
        out.write("                \n");
        out.write("                <div class=\"card text-white bg-primary mb-4 col-md-3\">\n");
        out.write("                    <div class=\"card-header\">Grafico 3</div>\n");
        out.write("                    <div class=\"card-body\">\n");
        out.write("                        <h5 class=\"card-title\">Título de Card Primary</h5>\n");
        out.write("                        <p class=\"card-text\">Um exemplo de texto rápido para construir o título do card e fazer preencher o conteúdo do card.</p>\n");
        out.write("                    </div>\n");
