...
public class TicketDAOImpl implements GenericDAO{
  ...
  java.sql.Date dataSql = new java.sql.Date(dataUtil.getTime());
    ...
    public Object carregar(int idObject) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Problemas ao fechar os par�metros de conexão! Erro: " + ex.getMessage());
            }
        }
        return ticket;
    }
    ...
    public Boolean finalizar(int idObject) {
       
        PreparedStatement stmt = null;
        ResultSet rs = null;

        String sql = "update ticket set status_ticket = 'F' WHERE id_ticket = ?;";
        ...
        try {
            ...
            System.out.println("Problemas ao Finalizar Ticket!  Erro: " + ex.getMessage());
            return false;
        } finally {
            try {
                ConnectionFactory.closeConnection(conn, stmt, rs);
