  ...
  java.sql.Date dataSql = new java.sql.Date(dataUtil.getTime());
    ...
    public List<Object> listar() {
      ...
      public List<Object> listarA(int idObject) {
        ...
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String sql = "select * from acompanhamento a inner join personal p on p.id_personal = a.id_personal inner join pessoa pe on pe.id_pessoa = p.id_pessoa where id_aluno = ? order by id_acompanhamento LIMIT 6 ";
    ...
    public Boolean excluir(int idObject) {
        ...
        try {
            ...
            System.out.println("Problemas ao Excluir Acompanhamento!  Erro: " + ex.getMessage());
            return false;
        } finally {
            try {
