 ...
 * @author Eric
 */
@WebServlet(name = "AtivarAcademia", urlPatterns = {"/AtivarAcademia"})
public class AtivarAcademia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.ativar(idAcademia)){
            String mensagem = "Academia ativada com sucesso";
            }else{
            String mensagem = "Erro Ao ativar Academia";
            }
