 ...
 */
@WebServlet(name = "CarregarPersonal", urlPatterns = {"/CarregarPersonal"})
public class CarregarPersonal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Problemas no servlet ao Carregar Personal!! Erro: " + e.getMessage());
        }
    }
