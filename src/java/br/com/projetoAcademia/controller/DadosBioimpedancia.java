 ...
 */
@WebServlet(name = "DadosBioimpedancia", urlPatterns = {"/DadosBioimpedancia"})
public class DadosBioimpedancia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer idAluno = Integer.parseInt(request.getParameter("idAluno"));
         try {
            ...
            request.setAttribute("bioimpedancias", dao.listarA(idAluno));
            request.setAttribute("idAluno",idAluno);
            request.getRequestDispatcher("personal/bioimpedancia/salvar.jsp").forward(request, response);
        } catch (Exception e) {
