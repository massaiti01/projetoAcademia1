 ...
 * @author Eric
 */
@WebServlet(name = "FinalizarTicket", urlPatterns = {"/FinalizarTicket"})
public class FinalizarTicket extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.finalizar(idTicket)){
            String mensagem = "Ticket finalizado com sucesso";
            }else{
